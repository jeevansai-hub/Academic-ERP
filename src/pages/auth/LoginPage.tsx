        ...
        <form onSubmit={handleSubmit} className={`flex flex-col flex-1 animate-fade-up animate-delay-500 ${error ? 'animate-[shake_0.4s]' : ''}`}>
          ...
          <div className="grid grid-cols-2 gap-3 mb-7 animate-fade-up animate-delay-900">
            <button 
              ...
              className="h-[46px] border-[1.5px] border-border-bluegrey rounded-[10px] bg-white text-charcoal font-body font-medium text-[13.5px] flex items-center justify-center gap-2 hover:border-blue-accent hover:bg-blue-pale hover:shadow-sm transition-all"
            >
